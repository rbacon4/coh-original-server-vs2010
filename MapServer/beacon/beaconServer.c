								...
								S32 noNetStart)
{
	...
	printf(	"\n\n[컴컴컴컴컴컴 BEACON %sSERVER RUNNING %s컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴]\n",
			beacon_server.isMasterServer ? "MASTER " :
				beacon_server.isRequestServer ? "REQUEST " :
					"",
			beacon_server.isMasterServer ? "" : "컴컴컴?");
...
static void printClientState(BeaconServerClientData* client, S32 index, void* userData){
	...
	printf("쳐컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴\n");
...
static void beaconServerPrintClientStates(void){
	...
	printf(	" ?n"
			"旼컴컴컨컴컴컴컴컴컴컨컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴\n"
			"?");
	...
	printf(	"읕컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴컴\n"
			"\n\n");
}
