...
#define MAXVER_INTERNALNAME "ViewportTexture\0"//should  be overridden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ViewportTexture.dlo\0"//should  be overridden on a per-dll level
